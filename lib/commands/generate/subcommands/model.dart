...
import 'package:wholesome_cli/commands/generate/subcommands/files/model.dart' as MODEL_FILE;
...
class GenerateModel extends Command {
  ...
  void createModel() {
    File(p.join(this.filesPath, this.fileName +'.dart')).create(recursive: true).then((File file) {
      file.writeAsString(MODEL_FILE.content(this.baseName, this.SUFIX)).then((file) {
